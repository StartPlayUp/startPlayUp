// import reducerAction from '../Reducer/yutStoreReducerAction';
...
//         sendDataToPeers(GAME, { nickname, peers, game: YUT, data: newState, reducerActionType: START_GAME });
//     } else {
...
//         && typeof (nickname) === "string"
//         && typeof (count) === "number") {
//         const { newState, yutView } = reducerAction.THROW_YUT(state, count);
//         dispatch({ type: THROW_YUT, state: newState });
//         sendDataToPeers(GAME, { nickname, peers, game: YUT, data: newState, reducerActionType: THROW_YUT });
//     }
//     else {
//         console.log(count)
...
//         sendDataToPeers(GAME, { nickname, peers, game: YUT, data: newState, reducerActionType: UPDATE_GOAL });
//     }
//     else {
...
//             sendDataToPeers(GAME, { nickname, peers, game: YUT, data: newState, reducerActionType: MOVE_FIRST_HORSE });
//         }
//         else {
//             alert("본인 차례가 아닙니다.")
//         }
...
//             sendDataToPeers(GAME, { nickname, peers, game: YUT, data: newState, reducerActionType: MOVE_HORSE });
//         }
//         else {
//             alert("본인 차례가 아닙니다.");
//         }
...
//             sendDataToPeers(GAME, { nickname, peers, game: YUT, data: newState, reducerActionType: NEXT_TURN });
//         }
//         else {
//             alert("본인 차례가 아닙니다.");
//         }
...
//         sendDataToPeers(GAME, { nickname, peers, game: YUT, data: newState, reducerActionType: PLAY_AI });
//     }
//     else {
