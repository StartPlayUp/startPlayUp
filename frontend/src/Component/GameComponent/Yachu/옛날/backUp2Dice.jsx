                ...
                <Fragment>
                    <ParentDiv>
                        ...
                        <ButtonTable ref={fromPosition}>
                            <>
                                {!hold[0] &&
                                    <HoldButton onClick={diceHold} value={0} hold={hold[0]} x1={boxX} y1={boxY} x2={placeX[0]} y={placeY}>
                                        <IMG src={diceImage[0]} />
                                    </HoldButton>
                                }
                                {!hold[1] &&
                                    <HoldButton onClick={diceHold} value={1} hold={hold[1]} x1={boxX} y1={boxY} x2={placeX[1]} y={placeY}>
                                        <IMG src={diceImage[1]} />
                                    </HoldButton>
                                }
                                {!hold[2] &&
                                    <HoldButton onClick={diceHold} value={2} hold={hold[2]} x1={boxX} y1={boxY} x2={placeX[2]} y={placeY}>
                                        <IMG src={diceImage[2]} />
                                    </HoldButton>
                                }
                                {!hold[3] &&
                                    <HoldButton onClick={diceHold} value={3} hold={hold[3]} x1={boxX} y1={boxY} x2={placeX[3]} y={placeY}>
                                        <IMG src={diceImage[3]} />
                                    </HoldButton>
                                }
                                {!hold[4] &&
                                    <HoldButton onClick={diceHold} value={4} hold={hold[4]} x1={boxX} y1={boxY} x2={placeX[4]} y={placeY}>
                                        <IMG src={diceImage[4]} />
                                    </HoldButton>
                                }
                            </>
